                ...
                <form method="POST" action="{{ route('admin.books.update', $book) }}" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            @if($book->image)
                                <div class="mb-2">
                                    <img src="{{ Storage::url($book->image) }}" alt="{{ $book->title }}" class="w-20 h-24 object-cover rounded">
                                </div>
                            @endif
                    ...
                    <div class="flex gap-4 mt-8">
                        <button type="submit" class="bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700">Update Book</button>

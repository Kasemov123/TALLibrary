<footer class="bg-white shadow-inner py-8 mt-auto">
    <div class="max-w-7xl mx-auto px-6">
        <div class="flex justify-between items-start px-8">
            <div class="max-w-md">
                <h3 class="text-2xl font-bold text-gray-800 mb-4">BookLibrary</h3>
                <p class="text-gray-600 mb-4">Your gateway to endless knowledge and adventure. Discover, read, and grow with our curated collection of books.</p>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="{{ route('books.index') }}" class="text-gray-600 hover:text-blue-600">Books</a></li>
                    <li><a href="{{ route('about') }}" class="text-gray-600 hover:text-blue-600">About Us</a></li>
                    <li><a href="{{ route('contact') }}" class="text-gray-600 hover:text-blue-600">Contact</a></li>
                </ul>
            </div>
        </div>
        
        <div class="border-t border-gray-200 mt-8 pt-8 text-center">
            <p class="text-gray-600">&copy; {{ date('Y') }} BookLibrary. All rights reserved.</p>
        </div>
    </div>
</footer>
